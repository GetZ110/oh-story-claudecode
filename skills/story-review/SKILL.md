...
- This applies to conversational output only. Keep quotations, manuscript edits, report field values, and other book artifacts in the language required by the source or book profile.
