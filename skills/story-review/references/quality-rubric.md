...
| Punctuation rhythm | Punctuation serves tone and character voice | Local punctuation flattening or manufactured pauses | Period flattening, random `?`/`!` stacking, or repeated `...`/`--` pauses distort the voice |
| Concrete word-count expressions | Numeric prose claims have a verifiable counting basis and narrative need | Count is plausible but not clearly grounded | Unverifiable counting claims distract from the scene or misstate the text |
