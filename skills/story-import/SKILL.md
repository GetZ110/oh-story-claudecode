...
- This applies to conversational output only. Preserve the source manuscript's language where required, while following the target book's declared language for generated project artifacts.
